...
def get_argparser():
    ...
    #parser.add_argument('--bg_dir', type=str, default='/vildata/guy/competitors_Results/')
    ...
    # BMN params 
    parser.add_argument("--BMN_ckpt_dir", type=str, default='/vildata/guy/BMN_checkpoints')
    parser.add_argument("--BMN_ckpt", default='tennis_BAC-997_best.ckpt', type=str)
